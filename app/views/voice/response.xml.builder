...
xml.Response do
  ...
  xml.Record(:action => "http://askadoc.herokuapp.com/voice/recording", :maxLength => 59, :finishOnKey => '1234567890*#', :transcribe => "true", :transcribeCallback => "http://askadoc.herokuapp.com/voice/recording")
